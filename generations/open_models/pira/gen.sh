...
declare -a output_files=("tucano_pira_r3.json" "bode_318B_pira_r3.json" "cabra_llama8b_pira_r3.json" "boto_gemma_pira_r3.json" "piriquito_ollama_pira_r3.json")
...
for i in "${!model_ids[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=0 python gen_pira_chat.py \
        --model_id "$model_id" \
