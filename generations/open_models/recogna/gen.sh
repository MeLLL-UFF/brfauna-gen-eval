...
declare -a output_files=("tucano_recogna_r3.json" "bode_318B_recogna_r3.json" "cabra_llama8b_recogna_r3.json" "boto_gemma_recogna_r3.json" "piriquito_ollama_recogna_r3.json")
...
for i in "${!model_ids[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=0 python gen_recogna_chat.py \
        --model_id "$model_id" \
